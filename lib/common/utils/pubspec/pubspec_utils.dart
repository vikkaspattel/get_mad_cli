...
class PubspecUtils {
  ...
  static final _mapSep = _PubValue<String>(() {
    ...
    if (yaml.containsKey('get_mad_cli')) {
      if ((yaml['get_mad_cli'] as Map).containsKey('separator')) {
        return (yaml['get_mad_cli']['separator'] as String?) ?? '';
      }
    }
  ...
  static final _extraFolder = _PubValue<bool?>(
    () {
      try {
        var yaml = pubSpec.unParsedYaml!;
        if (yaml.containsKey('get_mad_cli')) {
          if ((yaml['get_mad_cli'] as Map).containsKey('sub_folder')) {
            return (yaml['get_mad_cli']['sub_folder'] as bool?);
          }
        }
