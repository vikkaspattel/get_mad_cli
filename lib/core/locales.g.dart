...
class Locales {
  static const tr_TR = {
    ...
    'error_update_cli': 'get_mad_cli yükseltilirken bir hata oluştu',
  ...
  static const zh_CN = {
    ...
    'error_update_cli': '升级 get_mad_cli 错误',
    ...
    'info_cli_last_version_already_installed': '您已安装 get_mad_cli 最新版本',
